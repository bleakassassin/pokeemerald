...
#define FLAG_ENCOUNTERED_LATIAS_OR_LATIOS    0xCE // I don't think this flag does anything
...
#define FLAG_RECEIVED_2ND_LAVARIDGE_EGG      0xE9 // Edited Flag; Egg lady at Lavaridge gives Togepi Egg after beating game, getting Wynaut Egg
...
#define FLAG_RECEIVED_ALT_OUTFIT             0x112 // Edited Flag; now allows player to switch clothes at Pokemon Centers
...
#define FLAG_EXCHANGED_SCANNER               0x126 // Edited Flag; has Mystery Gift man give reward if player exchanges before beating the game.
...
#define FLAG_CAUGHT_SUDOWOODO                0x1DA
...
#define FLAG_ITEM_ALTERING_CAVE_VITAMIN_BALL                        0x468 // Edited Flag; cleared at the start of each day as part of revamped Altering Cave if player just entered it
...
#define FLAG_SYS_NATIVE_SAVE                         (SYSTEM_FLAGS + 0x3) // Edited Flag; set if save was made in hack and not imported from vanilla
...
#define FLAG_DAILY_GAVE_CONTEST_LADY_POKEBLOCK      (DAILY_FLAGS_START + 0x3)  // Edited Flag; cleared to allow player to give another Pokeblock to Contest Lady
