...
#define SCROLL_MULTI_BF_EXCHANGE_CORNER_DECOR_VENDOR_2R    5
#define SCROLL_MULTI_BF_EXCHANGE_CORNER_VITAMIN_VENDOR     6
#define SCROLL_MULTI_BF_EXCHANGE_CORNER_VITAMIN_VENDOR_S   7
#define SCROLL_MULTI_BF_EXCHANGE_CORNER_VITAMIN_VENDOR_G   8
#define SCROLL_MULTI_BF_EXCHANGE_CORNER_HOLD_ITEM_VENDOR   9
#define SCROLL_MULTI_BERRY_POWDER_VENDOR                  10
#define SCROLL_MULTI_BF_RECEPTIONIST                      11
#define SCROLL_MULTI_BF_MOVE_TUTOR_1                      12
#define SCROLL_MULTI_BF_MOVE_TUTOR_2                      13
#define SCROLL_MULTI_SS_TIDAL_DESTINATION                 14
#define SCROLL_MULTI_BATTLE_TENT_RULES                    15
#define SCROLL_MULTI_EXCHANGE_CORNER_NATURE_VENDOR        16
