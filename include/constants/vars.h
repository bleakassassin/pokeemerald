...
#define VAR_CONTEST_LADY_STATE                           0x408B // 0: normal, 1: won contest, 2: lost contest, 3: lost contest badly, 4: can't put on air, 5: gave 3rd starter mon
#define VAR_LITTLEROOT_HOUSES_STATE_BRENDAN              0x408C
#define VAR_LITTLEROOT_RIVAL_STATE                       0x408D
#define VAR_BOARD_BRINEY_BOAT_STATE                      0x408E
#define VAR_DEVON_CORP_3F_STATE                          0x408F
#define VAR_BRINEY_HOUSE_STATE                           0x4090
#define VAR_OLD_SEA_MAP_STATE                            0x4091 // 1: Interviewed, 2: Watched, 3: 1 day later and been in Altering Cave, 4: Received item, 5: Read sign at Faraway Island
...
#define VAR_HEART_SCALES_GIVEN_TO_RELEARNER              0x40B8 // Counts how many Heart Scales the player has given to the Relearner/Move Maniac; moves become free after giving 10 of them
...
#define VAR_WHICH_FOSSIL_REVIVED                         0x40C5 // 1: Root, 2: Claw, 3: Helix, 4: Dome, 5: Old Amber
...
#define VAR_TRAINER_HILL_PENDING_MON_PRIZE               0x40E5 // Stores prize Pokemon species if player's party and PC were full, ignored if 0
...
#define VAR_SAVE_COMPATIBILITY                           0x40FF // Used for imported saves or for editing saves after updates
