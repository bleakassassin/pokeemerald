...
#define BAG_BATTLEITEMS_COUNT 11
...
#define OPTIONS_GIVE_NICKNAMES_ON 0
#define OPTIONS_GIVE_NICKNAMES_OFF 1
...
#define VERSION_SAVE_REFACTOR        4
#define VERSION_POCKET_ENCRYPTION    5
#define VERSION_TRADE_OVERHAUL       6 
#define VERSION_LATEST               7 // VERSION_LUM_BERRY
