...
#define IS_CATEGORY_PHYSICAL(move) (gBattleMoves[move].category == CATEGORY_PHYSICAL)
#define IS_CATEGORY_SPECIAL(move) (gBattleMoves[move].category == CATEGORY_SPECIAL)
#define IS_CATEGORY_STATUS(move) (gBattleMoves[move].category == CATEGORY_STATUS)
