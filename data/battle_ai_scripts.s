...
AI_CV_Counter5:
	...
	score +1
AI_CV_Counter6:
	if_not_hard_difficulty AI_CV_Counter6_Bugged
	get_target_type1
	if_in_bytes AI_CV_Counter_PhysicalTypeList, AI_CV_Counter7
	get_target_type2
	if_in_bytes AI_CV_Counter_PhysicalTypeList, AI_CV_Counter7
	goto AI_CV_Counter_End
AI_CV_Counter6_Bugged:
	get_target_type1
...
AI_CV_Foresight:
	if_not_hard_difficulty AI_CV_Foresight_Bugged
	get_target_type1
...
AI_CV_MirrorCoat5:
	...
	score +1
AI_CV_MirrorCoat6:
	if_not_hard_difficulty AI_CV_MirrorCoat6_Bugged
	get_target_type1
	if_in_bytes AI_CV_MirrorCoat_SpecialTypeList, AI_CV_MirrorCoat7
	get_target_type2
	if_in_bytes AI_CV_MirrorCoat_SpecialTypeList, AI_CV_MirrorCoat7
	goto AI_CV_MirrorCoat_End
AI_CV_MirrorCoat6_Bugged:
	get_target_type1
...
AI_CV_SemiInvulnerable2:
	...
	get_weather
	if_not_hard_difficulty AI_CV_SemiInvulnerable2_Bugged
...
AI_CV_SemiInvulnerable2_Bugged:
...
AI_CV_Facade:
	if_not_hard_difficulty AI_CV_Facade_Bugged
...
AI_TrySunnyDayStart:
	...
	if_hard_difficulty AI_TrySunnyDayStart_Bugfix  @ funcResult has not been set in this script yet, below call is nonsense
	if_equal FALSE, AI_TrySunnyDayStart_End
AI_TrySunnyDayStart_Bugfix:
	is_first_turn_for AI_USER
	if_equal FALSE, AI_TrySunnyDayStart_End
	score +5
