...
const u16 gTilesetAnims_Dewford_BridgeWaterEdge_Frame0[] = INCGFX_U16("data/tilesets/secondary/dewford/anim/bridge_water_edge/0.png", ".4bpp");
const u16 gTilesetAnims_Dewford_BridgeWaterEdge_Frame1[] = INCGFX_U16("data/tilesets/secondary/dewford/anim/bridge_water_edge/1.png", ".4bpp");
const u16 gTilesetAnims_Dewford_BridgeWaterEdge_Frame2[] = INCGFX_U16("data/tilesets/secondary/dewford/anim/bridge_water_edge/2.png", ".4bpp");
const u16 gTilesetAnims_Dewford_BridgeWaterEdge_Frame3[] = INCGFX_U16("data/tilesets/secondary/dewford/anim/bridge_water_edge/3.png", ".4bpp");
const u16 gTilesetAnims_Dewford_BridgeWaterEdge_Frame4[] = INCGFX_U16("data/tilesets/secondary/dewford/anim/bridge_water_edge/4.png", ".4bpp");
const u16 gTilesetAnims_Dewford_BridgeWaterEdge_Frame5[] = INCGFX_U16("data/tilesets/secondary/dewford/anim/bridge_water_edge/5.png", ".4bpp");
const u16 gTilesetAnims_Dewford_BridgeWaterEdge_Frame6[] = INCGFX_U16("data/tilesets/secondary/dewford/anim/bridge_water_edge/6.png", ".4bpp");
