...
static void Task_StarterChoose(u8 taskId)
{
    ...
    AddTextPrinterParameterized(0, gSaveBlock2Ptr->optionsCurrentFont, gText_BirchInTrouble, 0, 1, 0, NULL);
    PutWindowTilemap(0);
...
static void Task_AskConfirmStarter(u8 taskId)
{
    ...
    AddTextPrinterParameterized(0, gSaveBlock2Ptr->optionsCurrentFont, gText_ConfirmStarterChoice, 0, 1, 0, NULL);
    ScheduleBgCopyTilemapToVram(0);
...
static void CreateStarterPokemonLabel(u8 selection)
{
    ...
    AddTextPrinterParameterized3(sStarterLabelWindowId, gSaveBlock2Ptr->optionsCurrentFont, width, 17, sTextColors, 0, speciesName);
