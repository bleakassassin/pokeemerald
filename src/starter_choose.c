...
static void Task_StarterChoose(u8 taskId)
{
    ...
    AddTextPrinterParameterized(0, gSaveBlock2Ptr->optionsCurrentFont, gText_BirchInTrouble, 0, 0, 0, NULL);
    PutWindowTilemap(0);
...
static void Task_AskConfirmStarter(u8 taskId)
{
    ...
    AddTextPrinterParameterized(0, gSaveBlock2Ptr->optionsCurrentFont, gText_ConfirmStarterChoice, 0, 0, 0, NULL);
    ScheduleBgCopyTilemapToVram(0);
...
static void CreateStarterPokemonLabel(u8 selection)
{
    ...
    width = GetStringCenterAlignXOffset(gSaveBlock2Ptr->optionsCurrentFont, speciesName, 0x68);
    AddTextPrinterParameterized3(sStarterLabelWindowId, gSaveBlock2Ptr->optionsCurrentFont, width, 16, sTextColors, 0, speciesName);
