...
static const u8 *const sScrollableMultichoiceOptions[][MAX_SCROLL_MULTI_LENGTH] =
{
    ...
    [SCROLL_MULTI_BF_EXCHANGE_CORNER_VITAMIN_VENDOR] =
    {
        ...
        gText_PetayaBerry128BP,
        gText_ApicotBerry128BP,
        gText_Exit
    },
...
{
    u8 objectEventId;
    LoadPalette(&sDeoxysRockPalettes[rockLevel], OBJ_PLTT_ID(1), PLTT_SIZEOF(4));
