...
static const u8 sRoamerLocations[][6] =
{
    ...
    { MAP_NUM(ROUTE104), MAP_NUM(ROUTE115), MAP_NUM(ROUTE116), ___, ___, ___ },
    ...
    { MAP_NUM(ROUTE114), MAP_NUM(ROUTE113), MAP_NUM(ROUTE111), ___, ___, ___ },
    { MAP_NUM(ROUTE115), MAP_NUM(ROUTE116), MAP_NUM(ROUTE104), ___, ___, ___ },
    { MAP_NUM(ROUTE116), MAP_NUM(ROUTE104), MAP_NUM(ROUTE115), ___, ___, ___ },
    { MAP_NUM(ROUTE117), MAP_NUM(ROUTE111), MAP_NUM(ROUTE110), MAP_NUM(ROUTE118), ___, ___ },
    { MAP_NUM(ROUTE118), MAP_NUM(ROUTE117), MAP_NUM(ROUTE110), MAP_NUM(ROUTE111), MAP_NUM(ROUTE119), ___ },
    ...
    { MAP_NUM(ROUTE123), MAP_NUM(ROUTE122), MAP_NUM(ROUTE121), ___, ___, ___ },
    ...
    { MAP_NUM(ROUTE132), MAP_NUM(ROUTE131), MAP_NUM(ROUTE130), ___, ___, ___ },
    { MAP_NUM(ROUTE134), MAP_NUM(ROUTE109), MAP_NUM(ROUTE110), ___, ___, ___ },
