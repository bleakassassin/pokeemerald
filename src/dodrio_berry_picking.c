...
static void Msg_WantToPlayAgain(void)
{
    ...
    case 1:
        ...
        AddTextPrinterParameterized(sGfx->windowIds[WIN_YES_NO], gSaveBlock2Ptr->optionsCurrentFont, gText_SelectorArrow2, 0, 1, TEXT_SKIP_DRAW, NULL);
    ...
    case 3:
        ...
        AddTextPrinterParameterized(sGfx->windowIds[WIN_YES_NO], gSaveBlock2Ptr->optionsCurrentFont, gText_Yes, 8, 1, TEXT_SKIP_DRAW, NULL);
        AddTextPrinterParameterized(sGfx->windowIds[WIN_YES_NO], gSaveBlock2Ptr->optionsCurrentFont, gText_No, 8, 17, TEXT_SKIP_DRAW, NULL);
        AddTextPrinterParameterized(sGfx->windowIds[WIN_YES_NO], gSaveBlock2Ptr->optionsCurrentFont, gText_SelectorArrow2, 0, ((y - 1) * 16) + 1, TEXT_SKIP_DRAW, NULL);
...
static void Msg_SavingDontTurnOff(void)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized2(0, gSaveBlock2Ptr->optionsCurrentFont, gText_SavingDontTurnOffPower, 0, NULL, 2, 1, 3);
        sGfx->state++;
        break;
    case 1:
...
static void Msg_CommunicationStandby(void)
{
    ...
    case 1:
        FillWindowPixelBuffer(sGfx->windowIds[0], PIXEL_FILL(1));
        AddTextPrinterParameterized(sGfx->windowIds[0], gSaveBlock2Ptr->optionsCurrentFont, gText_CommunicationStandby3, 0, 5, TEXT_SKIP_DRAW, NULL);
        CopyWindowToVram(sGfx->windowIds[0], COPYWIN_GFX);
        sGfx->state++;
        break;
    case 2:
