...
static void Select_PrintRentalPkmnString(void)
{
    ...
    AddTextPrinterParameterized(SELECT_WIN_TITLE, gSaveBlock2Ptr->optionsCurrentFont, gText_RentalPkmn, 2, 1, 0, NULL);
...
static void Select_PrintMenuOptions(void)
{
    ...
    AddTextPrinterParameterized3(SELECT_WIN_OPTIONS, gSaveBlock2Ptr->optionsCurrentFont, 7, 33, sMenuOptionTextColors, 0, gText_Others);
...
static void Select_PrintYesNoOptions(void)
{
    ...
    AddTextPrinterParameterized3(SELECT_WIN_YES_NO, gSaveBlock2Ptr->optionsCurrentFont, 7, 1, sMenuOptionTextColors, 0, gText_Yes);
    AddTextPrinterParameterized3(SELECT_WIN_YES_NO, gSaveBlock2Ptr->optionsCurrentFont, 7, 17, sMenuOptionTextColors, 0, gText_No);
...
static void Swap_PrintMenuOptions(void)
{
    ...
    AddTextPrinterParameterized3(SWAP_WIN_OPTIONS, gSaveBlock2Ptr->optionsCurrentFont, 15,  1, sSwapMenuOptionsTextColors, 0, gText_Summary);
...
static void Swap_PrintYesNoOptions(void)
{
    ...
    AddTextPrinterParameterized3(SWAP_WIN_YES_NO, gSaveBlock2Ptr->optionsCurrentFont, 7, 1,  sSwapMenuOptionsTextColors, 0, gText_Yes);
    AddTextPrinterParameterized3(SWAP_WIN_YES_NO, gSaveBlock2Ptr->optionsCurrentFont, 7, 17, sSwapMenuOptionsTextColors, 0, gText_No);
