...
static void Select_PrintRentalPkmnString(void)
{
    ...
    AddTextPrinterParameterized(SELECT_WIN_TITLE, gSaveBlock2Ptr->optionsCurrentFont, gText_RentalPkmn2, 2, 1, 0, NULL);
...
static void Select_PrintMonSpecies(void)
{
    ...
    x = GetStringRightAlignXOffset(gSaveBlock2Ptr->optionsCurrentFont, gStringVar4, 86);
    AddTextPrinterParameterized3(SELECT_WIN_SPECIES, gSaveBlock2Ptr->optionsCurrentFont, x, 1, sSpeciesNameTextColors, 0, gStringVar4);
...
static void Select_PrintSelectMonString(void)
{
    ...
    AddTextPrinterParameterized(SELECT_WIN_INFO, gSaveBlock2Ptr->optionsCurrentFont, str, 2, 5, 0, NULL);
...
{
    FillWindowPixelBuffer(SELECT_WIN_INFO, PIXEL_FILL(0));
    AddTextPrinterParameterized(SELECT_WIN_INFO, gSaveBlock2Ptr->optionsCurrentFont, gText_CantSelectSamePkmn, 2, 5, 0, NULL);
    CopyWindowToVram(SELECT_WIN_INFO, COPYWIN_GFX);
}
...
static void Select_PrintMenuOptions(void)
{
    ...
    AddTextPrinterParameterized3(SELECT_WIN_OPTIONS, gSaveBlock2Ptr->optionsCurrentFont, 7, 1, sMenuOptionTextColors, 0, gText_Summary);
    if (selectedId != 0)
        AddTextPrinterParameterized3(SELECT_WIN_OPTIONS, gSaveBlock2Ptr->optionsCurrentFont, 7, 17, sMenuOptionTextColors, 0, gText_Deselect);
    else
        AddTextPrinterParameterized3(SELECT_WIN_OPTIONS, gSaveBlock2Ptr->optionsCurrentFont, 7, 17, sMenuOptionTextColors, 0, gText_Rent);

    AddTextPrinterParameterized3(SELECT_WIN_OPTIONS, gSaveBlock2Ptr->optionsCurrentFont, 7, 33, sMenuOptionTextColors, 0, gText_Others2);
...
static void Select_PrintYesNoOptions(void)
{
    ...
    AddTextPrinterParameterized3(SELECT_WIN_YES_NO, gSaveBlock2Ptr->optionsCurrentFont, 7, 1, sMenuOptionTextColors, 0, gText_Yes2);
    AddTextPrinterParameterized3(SELECT_WIN_YES_NO, gSaveBlock2Ptr->optionsCurrentFont, 7, 17, sMenuOptionTextColors, 0, gText_No2);
...
static void Select_PrintMonCategory(void)
{
    ...
    if (monId < SELECTABLE_MONS_COUNT)
    {
        ...
        x = GetStringRightAlignXOffset(gSaveBlock2Ptr->optionsCurrentFont, text, 0x76);
        AddTextPrinterParameterized(SELECT_WIN_MON_CATEGORY, gSaveBlock2Ptr->optionsCurrentFont, text, x, 1, 0, NULL);
...
static void Swap_PrintPkmnSwap(void)
{
    ...
    AddTextPrinterParameterized(SWAP_WIN_TITLE, gSaveBlock2Ptr->optionsCurrentFont, gText_PkmnSwap, 2, 1, 0, NULL);
...
static void Swap_PrintMonSpecies(void)
{
    ...
    else
    {
        ...
        StringCopy(gStringVar4, gSpeciesNames[species]);
        x = GetStringRightAlignXOffset(gSaveBlock2Ptr->optionsCurrentFont, gStringVar4, 86);
        AddTextPrinterParameterized3(SWAP_WIN_SPECIES, gSaveBlock2Ptr->optionsCurrentFont, x, 1, sSwapSpeciesNameTextColors, 0, gStringVar4);
...
static void Swap_PrintOnInfoWindow(const u8 *str)
{
    ...
    AddTextPrinterParameterized(SWAP_WIN_INFO, gSaveBlock2Ptr->optionsCurrentFont, str, 2, 5, 0, NULL);
...
static void Swap_PrintMenuOptions(void)
{
    ...
    AddTextPrinterParameterized3(SWAP_WIN_OPTIONS, gSaveBlock2Ptr->optionsCurrentFont, 15,  1, sSwapMenuOptionsTextColors, 0, gText_Summary2);
    AddTextPrinterParameterized3(SWAP_WIN_OPTIONS, gSaveBlock2Ptr->optionsCurrentFont, 15, 17, sSwapMenuOptionsTextColors, 0, gText_Swap);
    AddTextPrinterParameterized3(SWAP_WIN_OPTIONS, gSaveBlock2Ptr->optionsCurrentFont, 15, 33, sSwapMenuOptionsTextColors, 0, gText_Rechoose);
...
static void Swap_PrintYesNoOptions(void)
{
    ...
    AddTextPrinterParameterized3(SWAP_WIN_YES_NO, gSaveBlock2Ptr->optionsCurrentFont, 7, 1,  sSwapMenuOptionsTextColors, 0, gText_Yes3);
    AddTextPrinterParameterized3(SWAP_WIN_YES_NO, gSaveBlock2Ptr->optionsCurrentFont, 7, 17, sSwapMenuOptionsTextColors, 0, gText_No3);
...
static void Swap_PrintMonSpeciesAtFade(void)
{
    ...
    else
    {
        ...
        StringCopy(gStringVar4, gSpeciesNames[species]);
        x = GetStringRightAlignXOffset(gSaveBlock2Ptr->optionsCurrentFont, gStringVar4, 86);
        AddTextPrinterParameterized3(SWAP_WIN_SPECIES_AT_FADE, gSaveBlock2Ptr->optionsCurrentFont, x, 1, sSwapSpeciesNameTextColors, 0, gStringVar4);
        CopyWindowToVram(SWAP_WIN_SPECIES_AT_FADE, COPYWIN_FULL);
    }
}
...
static void Swap_PrintMonCategory(void)
{
    ...
    else
    {
        ...
        CopyMonCategoryText(SpeciesToNationalPokedexNum(species), text);
        x = GetStringRightAlignXOffset(gSaveBlock2Ptr->optionsCurrentFont, text, 0x76);
        AddTextPrinterParameterized(SWAP_WIN_MON_CATEGORY, gSaveBlock2Ptr->optionsCurrentFont, text, x, 1, 0, NULL);
        CopyWindowToVram(SWAP_WIN_MON_CATEGORY, COPYWIN_GFX);
    }
}
