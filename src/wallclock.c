...
void CB2_StartWallClock(void)
{
    ...
    AddTextPrinterParameterized(1, gSaveBlock2Ptr->optionsCurrentFont, gText_Confirm3, 0, 1, 0, NULL);
    PutWindowTilemap(1);
...
void CB2_ViewWallClock(void)
{
    ...
    AddTextPrinterParameterized(1, gSaveBlock2Ptr->optionsCurrentFont, gText_Cancel4, 0, 1, 0, NULL);
    PutWindowTilemap(1);
    ScheduleBgCopyTilemapToVram(2);
}
...
static void Task_SetClock_AskConfirm(u8 taskId)
{
    ...
    AddTextPrinterParameterized(0, gSaveBlock2Ptr->optionsCurrentFont, gText_IsThisTheCorrectTime, 0, 1, 0, NULL);
    PutWindowTilemap(0);
