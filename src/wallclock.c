...
void CB2_StartWallClock(void)
{
    ...
    AddTextPrinterParameterized(WIN_BUTTON_LABEL, gSaveBlock2Ptr->optionsCurrentFont, gText_Confirm, 0, 0, 0, NULL);
...
static void Task_SetClock_AskConfirm(u8 taskId)
{
    ...
    AddTextPrinterParameterized(WIN_MSG, gSaveBlock2Ptr->optionsCurrentFont, gText_IsThisTheCorrectTime, 0, 0, 0, NULL);
