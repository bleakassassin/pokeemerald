...
static void Task_Hof_DisplayPlayer(u8 taskId)
{
    ...
    ShowBg(1);
    ShowBg(3);
    gTasks[taskId].tPlayerSpriteID = CreateTrainerPicSprite(GetTrainerFrontSpriteBasedOnPlayerOutfitAndGender(gSaveBlock2Ptr->outfitId, gSaveBlock2Ptr->playerGender), 1, 120, 72, 6, TAG_NONE);
...
static void Task_Hof_WaitAndPrintPlayerInfo(u8 taskId)
{
    ...
    else
    {
        ...
        DrawDialogueFrame(0, FALSE);
        AddTextPrinterParameterized2(0, gSaveBlock2Ptr->optionsCurrentFont, gText_LeagueChamp, 0, NULL, 2, 1, 3);
        CopyWindowToVram(0, COPYWIN_FULL);
...
static void Task_HofPC_PrintDataIsCorrupted(u8 taskId)
{
    ...
    DrawDialogueFrame(0, FALSE);
    AddTextPrinterParameterized2(0, gSaveBlock2Ptr->optionsCurrentFont, gText_HOFCorrupted, 0, NULL, 2, 1, 3);
    CopyWindowToVram(0, COPYWIN_FULL);
