...
static void ToggleLetterCase(void);
...
static void DisplaySentToPCMessage(void)
{
    ...
    AddTextPrinterParameterized2(0, gSaveBlock2Ptr->optionsCurrentFont, gStringVar4, GetPlayerTextSpeedDelay(), 0, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_WHITE, TEXT_COLOR_LIGHT_GRAY);
...
static void NamingScreen_CreatePlayerIcon(void)
{
    ...
    rivalGfxId = GetRSAvatarGraphicsIdByGender(sNamingScreen->monSpecies);
...
static void DrawNormalTextEntryBox(void)
{
    ...
    AddTextPrinterParameterized(sNamingScreen->windows[WIN_TEXT_ENTRY_BOX], gSaveBlock2Ptr->optionsCurrentFont, sNamingScreen->template->title, 8, 0, 0, 0);
...
static void DrawMonTextEntryBox(void)
{
    ...
    FillWindowPixelBuffer(sNamingScreen->windows[WIN_TEXT_ENTRY_BOX], PIXEL_FILL(1));
    AddTextPrinterParameterized(sNamingScreen->windows[WIN_TEXT_ENTRY_BOX], gSaveBlock2Ptr->optionsCurrentFont, buffer, 8, 0, 0, 0);
    PutWindowTilemap(sNamingScreen->windows[WIN_TEXT_ENTRY_BOX]);
}
