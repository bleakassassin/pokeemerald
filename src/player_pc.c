...
static void ItemStorage_EraseItemIcon(u8);
static void ItemStorage_DrawItemIcon(u16, u8);
...
{
    if (gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(MAP_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F))
    {
...
static void ItemStorage_PrintDescription(s32 id)
{
    ...
    AddTextPrinterParameterized(windowId, gSaveBlock2Ptr->optionsCurrentFont, description, 0, 1, 0, NULL);
}
...
static void ItemStorage_DrawSwapArrow(u8 y, u8 b, u8 speed)
{
    ...
    if (b == 0xFF)
        FillWindowPixelRect(windowId, PIXEL_FILL(1), 0, y, GetMenuCursorDimensionByFont(gSaveBlock2Ptr->optionsCurrentFont, 0), GetMenuCursorDimensionByFont(gSaveBlock2Ptr->optionsCurrentFont, 1));
    else
        AddTextPrinterParameterized4(windowId, gSaveBlock2Ptr->optionsCurrentFont, 0, y, 0, 0, sSwapArrowTextColors, speed, gText_SelectorArrow);
}
...
static void ItemStorage_CreateListMenu(u8 taskId)
{
    ...
    x = GetStringCenterAlignXOffset(gSaveBlock2Ptr->optionsCurrentFont, text, 104);
    AddTextPrinterParameterized(sItemStorageMenu->windowIds[ITEMPC_WIN_TITLE], gSaveBlock2Ptr->optionsCurrentFont, text, x, 1, 0, NULL);
...
static void ItemStorage_PrintMessage(const u8 *string)
{
    ...
    AddTextPrinterParameterized(windowId, gSaveBlock2Ptr->optionsCurrentFont, gStringVar4, 0, 1, 0, NULL);
}
...
static void ItemStorage_PrintItemQuantity(u8 windowId, u16 value, u32 mode, u8 x, u8 y, u8 n)
{
    ...
    StringExpandPlaceholders(gStringVar4, gText_xVar1);
    AddTextPrinterParameterized(windowId, gSaveBlock2Ptr->optionsCurrentFont, gStringVar4, GetStringCenterAlignXOffset(gSaveBlock2Ptr->optionsCurrentFont, gStringVar4, 48), y, 0, NULL);
}
