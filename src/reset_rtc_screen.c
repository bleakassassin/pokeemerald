...
static void PrintTime(u8 windowId, u8 x, u8 y, u16 days, u8 hours, u8 minutes, u8 seconds)
{
    ...
    AddTextPrinterParameterized(windowId, gSaveBlock2Ptr->optionsCurrentFont, gStringVar4, x, y, TEXT_SKIP_DRAW, NULL);
}
...
static void ShowChooseTimeWindow(u8 windowId, u16 days, u8 hours, u8 minutes, u8 seconds)
{
    ...
    AddTextPrinterParameterized(windowId, gSaveBlock2Ptr->optionsCurrentFont, gText_Confirm2, 126, 0, 0, NULL);
    ScheduleBgCopyTilemapToVram(0);
}
...
static void ShowMessage(const u8 *str)
{
    ...
    AddTextPrinterParameterized(1, gSaveBlock2Ptr->optionsCurrentFont, str, 0, 1, 0, NULL);
    ScheduleBgCopyTilemapToVram(0);
}
...
static void Task_ShowResetRtcPrompt(u8 taskId)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized(0, gSaveBlock2Ptr->optionsCurrentFont, gText_PresentTime, 0, 1, TEXT_SKIP_DRAW, 0);
        PrintTime(
            0,
            0,
            17,
        ...
        AddTextPrinterParameterized(0, gSaveBlock2Ptr->optionsCurrentFont, gText_PreviousTime, 0, 33, TEXT_SKIP_DRAW, 0);
        PrintTime(
            0,
            0,
            49,
