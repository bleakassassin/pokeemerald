...
static void Task_DoClearSaveDataScreenYesNo(u8 taskId)
{
    ...
    AddTextPrinterParameterized(0, gSaveBlock2Ptr->optionsCurrentFont, gText_ClearAllSaveData, 0, 0, 0, 0);
...
static void Task_ClearSaveDataScreenYesNoChoice(u8 taskId)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized(0, gSaveBlock2Ptr->optionsCurrentFont, gText_ClearingData, 0, 0, 0, 0);
