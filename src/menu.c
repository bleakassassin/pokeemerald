...
void AddTextPrinterForMessage(bool8 allowSkippingDelayWithButtonPress)
{
    ...
    AddTextPrinterParameterized2(0, gSaveBlock2Ptr->optionsCurrentFont, gStringVar4, GetPlayerTextSpeedDelay(), callback, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_WHITE, TEXT_COLOR_LIGHT_GRAY);
}

void AddTextPrinterForMessage_2(bool8 allowSkippingDelayWithButtonPress)
{
    gTextFlags.canABSpeedUpPrint = allowSkippingDelayWithButtonPress;
    AddTextPrinterParameterized2(0, gSaveBlock2Ptr->optionsCurrentFont, gStringVar4, GetPlayerTextSpeedDelay(), NULL, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_WHITE, TEXT_COLOR_LIGHT_GRAY);
}

void AddTextPrinterWithCustomSpeedForMessage(bool8 allowSkippingDelayWithButtonPress, u8 speed)
{
    gTextFlags.canABSpeedUpPrint = allowSkippingDelayWithButtonPress;
    AddTextPrinterParameterized2(0, gSaveBlock2Ptr->optionsCurrentFont, gStringVar4, speed, NULL, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_WHITE, TEXT_COLOR_LIGHT_GRAY);
}
...
{
    LoadMessageBoxAndBorderGfx();
    DisplayMessageAndContinueTask(taskId, 0, DLG_WINDOW_BASE_TILE_NUM, DLG_WINDOW_PALETTE_NUM, gSaveBlock2Ptr->optionsCurrentFont, GetPlayerTextSpeedDelay(), string, callback);
...
void HofPCTopBar_PrintPair(const u8 *string, const u8 *string2, bool8 noBg, u8 left, bool8 copyToVram)
{
    ...
    if (sHofPCTopBarWindowId != WINDOW_NONE)
    {
        ...
        AddTextPrinterParameterized4(sHofPCTopBarWindowId, gSaveBlock2Ptr->optionsCurrentFont, 4, 0, 0, 0, color, 0, string);
        if (copyToVram)
            CopyWindowToVram(sHofPCTopBarWindowId, COPYWIN_FULL);
    }
}
...
u8 InitMenuInUpperLeftCorner(u8 windowId, u8 itemCount, u8 initialCursorPos, bool8 APressMuted)
{
    ...
    sMenu.windowId = windowId;
    sMenu.fontId = gSaveBlock2Ptr->optionsCurrentFont;
...
void PrintMenuTable(u8 windowId, u8 itemCount, const struct MenuAction *menuActions)
{
    ...
    for (i = 0; i < itemCount; i++)
        AddTextPrinterParameterized(windowId, gSaveBlock2Ptr->optionsCurrentFont, menuActions[i].text, 8, (i * 16), TEXT_SKIP_DRAW, NULL);
...
void PrintMenuActionTextsInUpperLeftCorner(u8 windowId, u8 itemCount, const struct MenuAction *menuActions, const u8 *actionIds)
{
    ...
    printer.windowId = windowId;
    printer.fontId = gSaveBlock2Ptr->optionsCurrentFont;
    printer.fgColor = GetFontAttribute(gSaveBlock2Ptr->optionsCurrentFont, FONTATTR_COLOR_FOREGROUND);
    printer.bgColor = GetFontAttribute(gSaveBlock2Ptr->optionsCurrentFont, FONTATTR_COLOR_BACKGROUND);
    printer.shadowColor = GetFontAttribute(gSaveBlock2Ptr->optionsCurrentFont, FONTATTR_COLOR_SHADOW);
    printer.unk = GetFontAttribute(gSaveBlock2Ptr->optionsCurrentFont, FONTATTR_UNKNOWN);
    printer.letterSpacing = 0;
    printer.lineSpacing = 0;
    printer.x = 8;
    printer.currentX = 8;
...
void PrintPlayerNameOnWindow(u8 windowId, const u8 *src, u16 x, u16 y)
{
    ...
    AddTextPrinterParameterized(windowId, gSaveBlock2Ptr->optionsCurrentFont, gStringVar4, x, y, TEXT_SKIP_DRAW, 0);
}
