...
bool8 ScrCmd_messageinstant(struct ScriptContext *ctx)
{
    ...
    AddTextPrinterParameterized(0, gSaveBlock2Ptr->optionsCurrentFont, msg, 0, 0, 0, NULL);
    return FALSE;
}
...
bool8 ScrCmd_checkgivenicknamesoption(struct ScriptContext *ctx)
{
    gSpecialVar_Result = gSaveBlock2Ptr->optionsGiveNicknames;
    return FALSE;
}
