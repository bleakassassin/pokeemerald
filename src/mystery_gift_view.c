...
static void DrawCardWindow(u8 whichWindow)
{
    ...
    case CARD_WIN_HEADER:
    {
        ...
        if (sWonderCardData->card.idNumber != 0)
            AddTextPrinterParameterized3(windowId, gSaveBlock2Ptr->optionsCurrentFont, 166, 17, sCard_TextColorTable[sWonderCardData->gfx->titleTextPal], 0, sWonderCardData->idNumberText);
        break;
    }
    case CARD_WIN_BODY:
        // Print body text
