...
static bool32 PrintStartMenuActions(s8 *pIndex, u32 count)
{
    ...
    do
    {
        ...
        else
        {
            ...
            AddTextPrinterParameterized(GetStartMenuWindowId(), gSaveBlock2Ptr->optionsCurrentFont, gStringVar4, 8, (index << 4) + 8, TEXT_SKIP_DRAW, NULL);
        }
...
static bool32 InitStartMenuStep(void)
{
    ...
    case 4:
        ...
        break;
    case 5:
        sStartMenuCursorPos = InitMenuNormal(GetStartMenuWindowId(), gSaveBlock2Ptr->optionsCurrentFont, 0, 8, 16, sNumStartMenuActions, sStartMenuCursorPos);
...
static void ShowSaveInfoWindow(void)
{
    ...
    AddTextPrinterParameterized(sSaveInfoWindowId, gSaveBlock2Ptr->optionsCurrentFont, gStringVar4, 0, yOffset, TEXT_SKIP_DRAW, NULL);
