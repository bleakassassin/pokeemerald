...
void DrawTextWindowAndBufferTiles(const u8 *string, void *dst, u8 zero1, u8 zero2, s32 bytesToBuffer)
{
    ...
    AddTextPrinterParameterized4(windowId, gSaveBlock2Ptr->optionsCurrentFont, 0, 0, 0, 0, txtColor, TEXT_SKIP_DRAW, string);
...
static void UNUSED UnusedDrawTextWindow(const u8 *string, void *dst, u16 offset, u8 bgColor, u8 fgColor, u8 shadowColor)
{
    ...
    AddTextPrinterParameterized4(windowId, gSaveBlock2Ptr->optionsCurrentFont, 0, 2, 0, 0, txtColor, TEXT_SKIP_DRAW, string);
...
static void Task_PCMainMenu(u8 taskId)
{
    ...
    case STATE_LOAD:
        ...
        AddTextPrinterParameterized2(0, gSaveBlock2Ptr->optionsCurrentFont, sMainMenuTexts[sMainMenuOptionOrder[task->tSelectedOption]].desc, TEXT_SKIP_DRAW, NULL, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_WHITE, TEXT_COLOR_LIGHT_GRAY);
    ...
    case STATE_HANDLE_INPUT:
        ...
        case MENU_NOTHING_CHOSEN:
            ...
            if (task->tSelectedOption != task->tNextOption)
            {
                ...
                FillWindowPixelBuffer(0, PIXEL_FILL(1));
                AddTextPrinterParameterized2(0, gSaveBlock2Ptr->optionsCurrentFont, sMainMenuTexts[sMainMenuOptionOrder[task->tSelectedOption]].desc, 0, NULL, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_WHITE, TEXT_COLOR_LIGHT_GRAY);
            }
            break;
        case MENU_B_PRESSED:
        case OPTION_EXIT:
        ...
        default:
            if (sMainMenuOptionOrder[task->tInput] == OPTION_WITHDRAW && CountPartyMons() == PARTY_SIZE)
            {
                // Can't withdraw
                FillWindowPixelBuffer(0, PIXEL_FILL(1));
                AddTextPrinterParameterized2(0, gSaveBlock2Ptr->optionsCurrentFont, gText_PartyFull, 0, NULL, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_WHITE, TEXT_COLOR_LIGHT_GRAY);
            ...
            else if (sMainMenuOptionOrder[task->tInput] == OPTION_DEPOSIT && CountPartyMons() == 1)
            {
                // Can't deposit
                FillWindowPixelBuffer(0, PIXEL_FILL(1));
                AddTextPrinterParameterized2(0, gSaveBlock2Ptr->optionsCurrentFont, gText_JustOnePkmn, 0, NULL, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_WHITE, TEXT_COLOR_LIGHT_GRAY);
                task->tState = STATE_ERROR_MSG;
            }
            else
            {
    ...
    case STATE_ERROR_MSG:
        ...
        {
            FillWindowPixelBuffer(0, PIXEL_FILL(1));
            AddTextPrinterParameterized2(0, gSaveBlock2Ptr->optionsCurrentFont, sMainMenuTexts[task->tSelectedOption].desc, 0, NULL, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_WHITE, TEXT_COLOR_LIGHT_GRAY);
...
static void ChooseBoxMenu_PrintInfo(void)
{
    ...
    // Print box name
    center = GetStringCenterAlignXOffset(gSaveBlock2Ptr->optionsCurrentFont, boxName, 64);
    AddTextPrinterParameterized3(windowId, gSaveBlock2Ptr->optionsCurrentFont, center, 1, sChooseBoxMenu_TextColors, TEXT_SKIP_DRAW, boxName);
    ...
    center = GetStringCenterAlignXOffset(gSaveBlock2Ptr->optionsCurrentFont, numBoxMonsText, 64);
    AddTextPrinterParameterized3(windowId, gSaveBlock2Ptr->optionsCurrentFont, center, 17, sChooseBoxMenu_TextColors, TEXT_SKIP_DRAW, numBoxMonsText);
...
{
    return DISPLAY_WIDTH - 64 - GetStringWidth(gSaveBlock2Ptr->optionsCurrentFont, string, 0) / 2;
}
...
static void PrintItemDescription(void)
{
    ...
    AddTextPrinterParameterized5(WIN_ITEM_DESC, gSaveBlock2Ptr->optionsCurrentFont, description, 4, 0, 0, NULL, 0, 1);
}
