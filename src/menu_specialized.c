...
static void MailboxMenu_ItemPrintFunc(u8 windowId, u32 itemId, u8 y)
{
    ...
    AddTextPrinterParameterized4(windowId, gSaveBlock2Ptr->optionsCurrentFont, 8, y, 0, 0, sPlayerNameTextColors, TEXT_SKIP_DRAW, buffer);
}
...
u8 MailboxMenu_CreateList(struct PlayerPCItemPageStruct *page)
{
    ...
    gMultiuseListMenuTemplate.fontId = gSaveBlock2Ptr->optionsCurrentFont;
...
static void MoveRelearnerLoadBattleMoveDescription(u32 chosenMove)
{
    ...
    x = GetStringCenterAlignXOffset(gSaveBlock2Ptr->optionsCurrentFont, str, 128);
    AddTextPrinterParameterized(RELEARNERWIN_DESC_BATTLE, gSaveBlock2Ptr->optionsCurrentFont, str, x, 0, TEXT_SKIP_DRAW, NULL);

    str = gText_MoveRelearnerPP;
    AddTextPrinterParameterized(RELEARNERWIN_DESC_BATTLE, gSaveBlock2Ptr->optionsCurrentFont, str, 4, 40, TEXT_SKIP_DRAW, NULL);

    str = gText_MoveRelearnerPower;
    x = GetStringRightAlignXOffset(gSaveBlock2Ptr->optionsCurrentFont, str, 106);
    AddTextPrinterParameterized(RELEARNERWIN_DESC_BATTLE, gSaveBlock2Ptr->optionsCurrentFont, str, x, 24, TEXT_SKIP_DRAW, NULL);

    str = gText_MoveRelearnerAccuracy;
    x = GetStringRightAlignXOffset(gSaveBlock2Ptr->optionsCurrentFont, str, 106);
    AddTextPrinterParameterized(RELEARNERWIN_DESC_BATTLE, gSaveBlock2Ptr->optionsCurrentFont, str, x, 40, TEXT_SKIP_DRAW, NULL);
    ...
    AddTextPrinterParameterized(RELEARNERWIN_DESC_BATTLE, gSaveBlock2Ptr->optionsCurrentFont, str, 4, 24, TEXT_SKIP_DRAW, NULL);
    ...
    AddTextPrinterParameterized(RELEARNERWIN_DESC_BATTLE, gSaveBlock2Ptr->optionsCurrentFont, buffer, x, 40, TEXT_SKIP_DRAW, NULL);
    ...
    AddTextPrinterParameterized(RELEARNERWIN_DESC_BATTLE, gSaveBlock2Ptr->optionsCurrentFont, str, 106, 24, TEXT_SKIP_DRAW, NULL);
...
static void MoveRelearnerMenuLoadContestMoveDescription(u32 chosenMove)
{
    ...
    x = GetStringCenterAlignXOffset(gSaveBlock2Ptr->optionsCurrentFont, str, 128);
    AddTextPrinterParameterized(RELEARNERWIN_DESC_CONTEST, gSaveBlock2Ptr->optionsCurrentFont, str, x, 0, TEXT_SKIP_DRAW, NULL);

    str = gText_MoveRelearnerAppeal;
    x = GetStringRightAlignXOffset(gSaveBlock2Ptr->optionsCurrentFont, str, 92);
    AddTextPrinterParameterized(RELEARNERWIN_DESC_CONTEST, gSaveBlock2Ptr->optionsCurrentFont, str, x, 24, TEXT_SKIP_DRAW, NULL);

    str = gText_MoveRelearnerJam;
    x = GetStringRightAlignXOffset(gSaveBlock2Ptr->optionsCurrentFont, str, 92);
    AddTextPrinterParameterized(RELEARNERWIN_DESC_CONTEST, gSaveBlock2Ptr->optionsCurrentFont, str, x, 40, TEXT_SKIP_DRAW, NULL);
...
void MoveRelearnerPrintMessage(u8 *str)
{
    ...
    AddTextPrinterParameterized2(RELEARNERWIN_MSG, gSaveBlock2Ptr->optionsCurrentFont, str, speed, NULL, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_WHITE, 3);
}
