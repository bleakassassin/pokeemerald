...
static void Msg_WantToPlayAgain(void)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized(sPokemonJumpGfx->msgWindowId, gSaveBlock2Ptr->optionsCurrentFont, gText_WantToPlayAgain, 0, 1, TEXT_SKIP_DRAW, NULL);
...
static void Msg_SomeoneDroppedOut(void)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized(sPokemonJumpGfx->msgWindowId, gSaveBlock2Ptr->optionsCurrentFont, gText_SomeoneDroppedOut, 0, 1, TEXT_SKIP_DRAW, NULL);
        CopyWindowToVram(sPokemonJumpGfx->msgWindowId, COPYWIN_GFX);
        sPokemonJumpGfx->mainState++;
        break;
    case 1:
...
static void Msg_CommunicationStandby(void)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized(sPokemonJumpGfx->msgWindowId, gSaveBlock2Ptr->optionsCurrentFont, gText_CommunicationStandby, 0, 1, TEXT_SKIP_DRAW, NULL);
        CopyWindowToVram(sPokemonJumpGfx->msgWindowId, COPYWIN_GFX);
        sPokemonJumpGfx->mainState++;
        break;
    case 1:
