...
static void Msg_WantToPlayAgain(void)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized(sPokemonJumpGfx->msgWindowId, gSaveBlock2Ptr->optionsCurrentFont, gText_WantToPlayAgain2, 0, 1, TEXT_SKIP_DRAW, NULL);
...
static void Msg_SavingDontTurnOff(void)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized(sPokemonJumpGfx->msgWindowId, gSaveBlock2Ptr->optionsCurrentFont, gText_SavingDontTurnOffPower, 0, 1, TEXT_SKIP_DRAW, NULL);
        CopyWindowToVram(sPokemonJumpGfx->msgWindowId, COPYWIN_GFX);
        sPokemonJumpGfx->mainState++;
        break;
    case 1:
...
static void Msg_SomeoneDroppedOut(void)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized(sPokemonJumpGfx->msgWindowId, gSaveBlock2Ptr->optionsCurrentFont, gText_SomeoneDroppedOut2, 0, 1, TEXT_SKIP_DRAW, NULL);
        CopyWindowToVram(sPokemonJumpGfx->msgWindowId, COPYWIN_GFX);
        sPokemonJumpGfx->mainState++;
        break;
    case 1:
...
static void Msg_CommunicationStandby(void)
{
    ...
    case 0:
        ...
        AddTextPrinterParameterized(sPokemonJumpGfx->msgWindowId, gSaveBlock2Ptr->optionsCurrentFont, gText_CommunicationStandby4, 0, 1, TEXT_SKIP_DRAW, NULL);
        CopyWindowToVram(sPokemonJumpGfx->msgWindowId, COPYWIN_GFX);
        sPokemonJumpGfx->mainState++;
        break;
    case 1:
...
static void PrintPrizeMessage(u16 itemId, u16 quantity)
{
    ...
    AddTextPrinterParameterized(sPokemonJumpGfx->msgWindowId, gSaveBlock2Ptr->optionsCurrentFont, sPokemonJumpGfx->prizeMsg, 0, 1, TEXT_SKIP_DRAW, NULL);
    CopyWindowToVram(sPokemonJumpGfx->msgWindowId, COPYWIN_GFX);
...
static void PrintPokeJumpPlayerName(int multiplayerId, u8 bgColor, u8 fgColor, u8 shadow)
{
    ...
    x = 64 - GetStringWidth(gSaveBlock2Ptr->optionsCurrentFont, GetPokeJumpPlayerName(multiplayerId), -1);
    x /= 2;
    AddTextPrinterParameterized3(sPokemonJumpGfx->nameWindowIds[multiplayerId], gSaveBlock2Ptr->optionsCurrentFont, x, 1, colors, TEXT_SKIP_DRAW, GetPokeJumpPlayerName(multiplayerId));
...
static void Task_ShowPokemonJumpRecords(u8 taskId)
{
    ...
    case 0:
        ...
        width = GetStringWidth(gSaveBlock2Ptr->optionsCurrentFont, gText_PkmnJumpRecords, 0);
        for (i = 0; i < ARRAY_COUNT(sRecordsTexts); i++)
        {
            widthCurr = GetStringWidth(gSaveBlock2Ptr->optionsCurrentFont, sRecordsTexts[i], 0) + 38;
            if (widthCurr > width)
                width = widthCurr;
        }
        width = (width + 7) / 8;
...
static void PrintRecordsText(u16 windowId, int width)
{
    ...
    AddTextPrinterParameterized(windowId, gSaveBlock2Ptr->optionsCurrentFont, gText_PkmnJumpRecords, GetStringCenterAlignXOffset(gSaveBlock2Ptr->optionsCurrentFont, gText_PkmnJumpRecords, width * 8), 1, TEXT_SKIP_DRAW, NULL);
    for (i = 0; i < ARRAY_COUNT(sRecordsTexts); i++)
    {
        AddTextPrinterParameterized(windowId, gSaveBlock2Ptr->optionsCurrentFont, sRecordsTexts[i], 0, 25 + (i * 16), TEXT_SKIP_DRAW, NULL);
        ConvertIntToDecimalStringN(gStringVar1, recordNums[i], STR_CONV_MODE_LEFT_ALIGN, 5);
        TruncateToFirstWordOnly(gStringVar1);
        x = (width * 8) - GetStringWidth(gSaveBlock2Ptr->optionsCurrentFont, gStringVar1, 0);
        AddTextPrinterParameterized(windowId, gSaveBlock2Ptr->optionsCurrentFont, gStringVar1, x, 25 + (i * 16), TEXT_SKIP_DRAW, NULL);
    }
