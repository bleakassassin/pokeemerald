...
const u8 gText_TreeckoDollAndPrice[] = _("TREECKO DOLL{CLEAR_TO 0x48}1,000 COINS");
const u8 gText_TorchicDollAndPrice[] = _("TORCHIC DOLL{CLEAR_TO 0x48}1,000 COINS");
...
const u8 gText_TM32AndPrice[] = _("SILK SCARF{CLEAR_TO 0x48}1,000 COINS");
const u8 gText_TM29AndPrice[] = _("MIRACLE SEED{CLEAR_TO 0x48}1,000 COINS");
const u8 gText_TM35AndPrice[] = _("SILVERPOWDER{CLEAR_TO 0x48}1,000 COINS");
const u8 gText_TM24AndPrice[] = _("NEVERMELTICE{CLEAR_TO 0x48}1,000 COINS");
const u8 gText_TM13AndPrice[] = _("BLACKGLASSES{CLEAR_TO 0x48}1,000 COINS");
const u8 gText_EeveeAndPrice[] = _("EEVEE{CLEAR_TO 0x40}2,500 COINS");
const u8 gText_DratiniAndPrice[] = _("DRATINI{CLEAR_TO 0x40}2,800 COINS");
const u8 gText_HitmonleeAndPrice[] = _("HITMONLEE{CLEAR_TO 0x40}4,600 COINS");
const u8 gText_HitmonchanAndPrice[] = _("HITMONCHAN{CLEAR_TO 0x40}4,600 COINS");
const u8 gText_PorygonAndPrice[] = _("PORYGON{CLEAR_TO 0x40}6,500 COINS");
...
const u8 gText_KissPoster16BP[] = _("KISS POSTER{CLEAR_TO 0x64}8BP");
const u8 gText_KissCushion32BP[] = _("KISS CUSHION{CLEAR_TO 0x5E}12BP");
const u8 gText_SmoochumDoll32BP[] = _("SMOOCHUM DOLL{CLEAR_TO 0x5E}16BP");
const u8 gText_TogepiDoll48BP[] = _("TOGEPI DOLL{CLEAR_TO 0x5E}16BP");
const u8 gText_MeowthDoll48BP[] = _("MEOWTH DOLL{CLEAR_TO 0x5E}16BP");
const u8 gText_ClefairyDoll48BP[] = _("CLEFAIRY DOLL{CLEAR_TO 0x5E}16BP");
const u8 gText_DittoDoll48BP[] = _("DITTO DOLL{CLEAR_TO 0x5E}16BP");
const u8 gText_CyndaquilDoll80BP[] = _("CYNDAQUIL DOLL{CLEAR_TO 0x5E}24BP");
const u8 gText_ChikoritaDoll80BP[] = _("CHIKORITA DOLL{CLEAR_TO 0x5E}24BP");
const u8 gText_TotodileDoll80BP[] = _("TOTODILE DOLL{CLEAR_TO 0x5E}24BP");
const u8 gText_LaprasDoll128BP[] = _("LAPRAS DOLL{CLEAR_TO 0x5E}40BP");
const u8 gText_SnorlaxDoll128BP[] = _("SNORLAX DOLL{CLEAR_TO 0x5E}40BP");
const u8 gText_VenusaurDoll256BP[] = _("VENUSAUR DOLL{CLEAR_TO 0x5E}64BP");
const u8 gText_CharizardDoll256BP[] = _("CHARIZARD DOLL{CLEAR_TO 0x5E}64BP");
const u8 gText_BlastoiseDoll256BP[] = _("BLASTOISE DOLL{CLEAR_TO 0x5E}64BP");
const u8 gText_RegirockDoll256BP[] = _("REGIROCK DOLL{CLEAR_TO 0x58}128BP");
const u8 gText_RegiceDoll256BP[] = _("REGICE DOLL{CLEAR_TO 0x58}128BP");
const u8 gText_RegisteelDoll256BP[] = _("REGISTEEL DOLL{CLEAR_TO 0x58}128BP");
...
const u8 gText_MachoBrace16BP[] = _("MACHO BRACE{CLEAR_TO 0x64}8BP");
const u8 gText_AbilityCapsule24BP[] = _("ABILITY CAP{CLEAR_TO 0x5E}24BP");
const u8 gText_RareCandy64BP[] = _("RARE CANDY{CLEAR_TO 0x5E}24BP");
const u8 gText_LiechiBerry128BP[] = _("LIECHI BERRY{CLEAR_TO 0x5E}64BP");
const u8 gText_GanlonBerry128BP[] = _("GANLON BERRY{CLEAR_TO 0x5E}64BP");
const u8 gText_SalacBerry128BP[] = _("SALAC BERRY{CLEAR_TO 0x5E}64BP");
const u8 gText_PetayaBerry128BP[] = _("PETAYA BERRY{CLEAR_TO 0x5E}64BP");
const u8 gText_ApicotBerry128BP[] = _("APICOT BERRY{CLEAR_TO 0x5E}64BP");
const u8 gText_LansatBerry256BP[] = _("LANSAT BERRY{CLEAR_TO 0x58}128BP");
const u8 gText_StarfBerry256BP[] = _("STARF BERRY{CLEAR_TO 0x58}128BP");
const u8 gText_Leftovers48BP[] = _("LEFTOVERS{CLEAR_TO 0x5E}24BP");
const u8 gText_WhiteHerb48BP[] = _("WHITE HERB{CLEAR_TO 0x5E}12BP");
const u8 gText_QuickClaw48BP[] = _("QUICK CLAW{CLEAR_TO 0x5E}24BP");
const u8 gText_MentalHerb48BP[] = _("MENTAL HERB{CLEAR_TO 0x5E}12BP");
const u8 gText_BrightPowder64BP[] = _("BRIGHTPOWDER{CLEAR_TO 0x5E}24BP");
const u8 gText_ChoiceBand64BP[] = _("CHOICE BAND{CLEAR_TO 0x5E}24BP");
const u8 gText_KingsRock64BP[] = _("KING'S ROCK{CLEAR_TO 0x5E}16BP");
const u8 gText_Everstone16BP[] = _("EVERSTONE{CLEAR_TO 0x64}8BP");
const u8 gText_UpGrade32BP[] = _("UPGRADE{CLEAR_TO 0x5E}16BP");
const u8 gText_DeepSeaTooth32BP[] = _("DEEPSEATOOTH{CLEAR_TO 0x5E}16BP");
const u8 gText_DeepSeaScale32BP[] = _("DEEPSEASCALE{CLEAR_TO 0x5E}16BP");
const u8 gText_DragonScale32BP[] = _("DRAGON SCALE{CLEAR_TO 0x5E}16BP");
const u8 gText_SootheBell64BP[] = _("SOOTHE BELL{CLEAR_TO 0x5E}24BP");
const u8 gText_FocusBand64BP[] = _("FOCUS BAND{CLEAR_TO 0x5E}24BP");
const u8 gText_ScopeLens64BP[] = _("SCOPE LENS{CLEAR_TO 0x5E}24BP");
const u8 gText_Softboiled16BP[] = _("SOFTBOILED{CLEAR_TO 0x54}4BP");
const u8 gText_SeismicToss24BP[] = _("SEISMIC TOSS{CLEAR_TO 0x54}4BP");
const u8 gText_DreamEater24BP[] = _("DREAM EATER{CLEAR_TO 0x54}4BP");
const u8 gText_MegaPunch24BP[] = _("MEGA PUNCH{CLEAR_TO 0x54}4BP");
const u8 gText_MegaKick48BP[] = _("MEGA KICK{CLEAR_TO 0x54}6BP");
const u8 gText_BodySlam48BP[] = _("BODY SLAM{CLEAR_TO 0x54}6BP");
const u8 gText_RockSlide48BP[] = _("ROCK SLIDE{CLEAR_TO 0x54}4BP");
const u8 gText_Counter48BP[] = _("COUNTER{CLEAR_TO 0x54}8BP");
const u8 gText_ThunderWave48BP[] = _("THUNDER WAVE{CLEAR_TO 0x54}4BP");
const u8 gText_SwordsDance48BP[] = _("SWORDS DANCE{CLEAR_TO 0x54}4BP");
const u8 gText_DefenseCurl16BP[] = _("DEFENSE CURL{CLEAR_TO 0x54}2BP");
const u8 gText_Snore24BP[] = _("SNORE{CLEAR_TO 0x54}2BP");
const u8 gText_Nightmare24BP[] = _("NIGHTMARE{CLEAR_TO 0x54}4BP");
const u8 gText_MudSlap24BP[] = _("MUD-SLAP{CLEAR_TO 0x54}4BP");
const u8 gText_Swift24BP[] = _("SWIFT{CLEAR_TO 0x54}2BP");
const u8 gText_IcyWind24BP[] = _("ICY WIND{CLEAR_TO 0x54}6BP");
const u8 gText_SelfDestruct24BP[] = _("SELFDESTRUCT{CLEAR_TO 0x54}8BP");
const u8 gText_Endure48BP[] = _("ENDURE{CLEAR_TO 0x54}4BP");
const u8 gText_PsychUp48BP[] = _("PSYCH UP{CLEAR_TO 0x54}4BP");
const u8 gText_IcePunch48BP[] = _("ICE PUNCH{CLEAR_TO 0x54}4BP");
const u8 gText_ThunderPunch48BP[] = _("THUNDERPUNCH{CLEAR_TO 0x54}4BP");
const u8 gText_FirePunch48BP[] = _("FIRE PUNCH{CLEAR_TO 0x54}4BP");
const u8 gText_SkyAttack48BP[] = _("SKY ATTACK{CLEAR_TO 0x54}8BP");
