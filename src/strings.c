...
const u8 gText_TyrogueAndPrice[] = _("TYROGUE{CLEAR_TO 0x40}2,500 COINS");
const u8 gText_MrMimeAndPrice[] = _("MR. MIME{CLEAR_TO 0x40}2,800 COINS");
const u8 gText_LickitungAndPrice[] = _("LICKITUNG{CLEAR_TO 0x40}4,600 COINS");
const u8 gText_EeveeAndPrice[] = _("EEVEE{CLEAR_TO 0x40}5,500 COINS");
