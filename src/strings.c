...
const u8 gText_EmptyHeight[] = _("          m"); // Used for metric
const u8 gText_EmptyWeight[] = _("          kg"); // Used for metric
...
const u8 gText_ItemFinderNearby[] = _("Huh?\nThe DOWSING MCHN's responding!\pThere's an item buried around here!{PAUSE_UNTIL_PRESS}");
const u8 gText_ItemFinderOnTop[] = _("Oh!\nThe DOWSING MCHN's shaking wildly!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PlayerUsedVar2_ow[] = _("{PLAYER} used the\n{STR_VAR_2}.");
...
const u8 gText_MoveItemWhere[] = _("Move {STR_VAR_2} where?");
...
const u8 gText_SoldOut[] = _("I'm sorry, but that item is sold out.{PAUSE_UNTIL_PRESS}"); // Sold out dialogue
const u8 gText_SoldOutLabel[] = _("SOLD OUT"); // Sold out price label
...
const u8 gText_PkmnLearnedMove[] = _("{STR_VAR_1} learned\n{STR_VAR_2}!");
...
const u8 gText_StopLearningMove[] = _("Stop trying to teach\n{STR_VAR_2}?");
...
const u8 gText_PkmnCantLearnUltimateMove[] = _("{STR_VAR_1} can't learn an\nultimate move.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PkmnSwitchedAbilities[] = _("{STR_VAR_1} switched ABILITIES!{PAUSE_UNTIL_PRESS}");
...
const u8 gText_DistantLand[] = _("from a distant land");
...
const u8 gText_TreeckoDollAndPrice[] = _("TREECKO DOLL{CLEAR_TO 72}1,000 COINS");
const u8 gText_TorchicDollAndPrice[] = _("TORCHIC DOLL{CLEAR_TO 72}1,000 COINS");
const u8 gText_MudkipDollAndPrice[] = _("MUDKIP DOLL{CLEAR_TO 72}1,000 COINS");
...
const u8 gText_TM32AndPrice[] = _("SILK SCARF{CLEAR_TO 72}1,000 COINS");
const u8 gText_TM29AndPrice[] = _("MIRACLE SEED{CLEAR_TO 72}1,000 COINS");
const u8 gText_TM35AndPrice[] = _("SILVERPOWDER{CLEAR_TO 72}1,000 COINS");
const u8 gText_TM24AndPrice[] = _("NEVERMELTICE{CLEAR_TO 72}1,000 COINS");
const u8 gText_TM13AndPrice[] = _("BLACKGLASSES{CLEAR_TO 72}1,000 COINS");
const u8 gText_EeveeAndPrice[] = _("EEVEE{CLEAR_TO 64}2,500 COINS");
const u8 gText_DratiniAndPrice[] = _("DRATINI{CLEAR_TO 64}2,800 COINS");
const u8 gText_HitmonleeAndPrice[] = _("HITMONLEE{CLEAR_TO 64}4,600 COINS");
const u8 gText_HitmonchanAndPrice[] = _("HITMONCHAN{CLEAR_TO 64}4,600 COINS");
const u8 gText_PorygonAndPrice[] = _("PORYGON{CLEAR_TO 64}6,500 COINS");
...
const u8 gText_PokenavMap_ZoomedOutButtonsFly[] = _("{A_BUTTON}ZOOM {B_BUTTON}CANCEL {R_BUTTON}FLY");
const u8 gText_PokenavMap_ZoomedInButtonsFly[] = _("{A_BUTTON}FULL {B_BUTTON}CANCEL {R_BUTTON}FLY");
...
const u8 gText_KissPoster16BP[] = _("KISS POSTER{CLEAR_TO 100}8BP");
const u8 gText_KissCushion32BP[] = _("KISS CUSHION{CLEAR_TO 94}16BP");
const u8 gText_SmoochumDoll32BP[] = _("SMOOCHUM DOLL{CLEAR_TO 94}32BP");
const u8 gText_TogepiDoll48BP[] = _("TOGEPI DOLL{CLEAR_TO 94}32BP");
const u8 gText_MeowthDoll48BP[] = _("MEOWTH DOLL{CLEAR_TO 94}32BP");
const u8 gText_ClefairyDoll48BP[] = _("CLEFAIRY DOLL{CLEAR_TO 94}32BP");
const u8 gText_DittoDoll48BP[] = _("DITTO DOLL{CLEAR_TO 94}32BP");
const u8 gText_CyndaquilDoll80BP[] = _("CYNDAQUIL DOLL{CLEAR_TO 94}48BP");
const u8 gText_ChikoritaDoll80BP[] = _("CHIKORITA DOLL{CLEAR_TO 94}48BP");
const u8 gText_TotodileDoll80BP[] = _("TOTODILE DOLL{CLEAR_TO 94}48BP");
const u8 gText_LaprasDoll128BP[] = _("LAPRAS DOLL{CLEAR_TO 94}80BP");
const u8 gText_SnorlaxDoll128BP[] = _("SNORLAX DOLL{CLEAR_TO 94}80BP");
const u8 gText_VenusaurDoll256BP[] = _("VENUSAUR DOLL{CLEAR_TO 88}128BP");
const u8 gText_CharizardDoll256BP[] = _("CHARIZARD DOLL{CLEAR_TO 88}128BP");
const u8 gText_BlastoiseDoll256BP[] = _("BLASTOISE DOLL{CLEAR_TO 88}128BP");
const u8 gText_RegirockDoll256BP[] = _("REGIROCK DOLL{CLEAR_TO 88}256BP");
const u8 gText_RegiceDoll256BP[] = _("REGICE DOLL{CLEAR_TO 88}256BP");
const u8 gText_RegisteelDoll256BP[] = _("REGISTEEL DOLL{CLEAR_TO 88}256BP");
...
const u8 gText_MachoBrace10BP[] = _("MACHO BRACE{CLEAR_TO 94}10BP");
const u8 gText_RareCandy20BP[] = _("RARE CANDY{CLEAR_TO 94}20BP");
const u8 gText_AbilityCapsule50BP[] = _("ABILITY CAP{CLEAR_TO 94}50BP");
const u8 gText_LiechiBerry50BP[] = _("LIECHI BERRY{CLEAR_TO 94}50BP");
const u8 gText_GanlonBerry50BP[] = _("GANLON BERRY{CLEAR_TO 94}50BP");
const u8 gText_SalacBerry50BP[] = _("SALAC BERRY{CLEAR_TO 94}50BP");
const u8 gText_PetayaBerry50BP[] = _("PETAYA BERRY{CLEAR_TO 94}50BP");
const u8 gText_ApicotBerry50BP[] = _("APICOT BERRY{CLEAR_TO 94}50BP");
const u8 gText_LansatBerry100BP[] = _("LANSAT BERRY{CLEAR_TO 88}100BP");
const u8 gText_StarfBerry200BP[] = _("STARF BERRY{CLEAR_TO 88}200BP");
const u8 gText_UpGrade5BP[] = _("UPGRADE{CLEAR_TO 100}5BP");
const u8 gText_DragonScale5BP[] = _("DRAGON SCALE{CLEAR_TO 100}5BP");
const u8 gText_Everstone10BP[] = _("EVERSTONE{CLEAR_TO 94}10BP");
const u8 gText_DeepSeaTooth10BP[] = _("DEEPSEATOOTH{CLEAR_TO 94}10BP");
const u8 gText_DeepSeaScale10BP[] = _("DEEPSEASCALE{CLEAR_TO 94}10BP");
const u8 gText_WhiteHerb48BP[] = _("WHITE HERB{CLEAR_TO 94}15BP");
const u8 gText_MentalHerb48BP[] = _("MENTAL HERB{CLEAR_TO 94}15BP");
const u8 gText_QuickClaw48BP[] = _("QUICK CLAW{CLEAR_TO 94}20BP");
const u8 gText_BrightPowder64BP[] = _("BRIGHTPOWDER{CLEAR_TO 94}20BP");
const u8 gText_KingsRock64BP[] = _("KING'S ROCK{CLEAR_TO 94}20BP");
const u8 gText_FocusBand64BP[] = _("FOCUS BAND{CLEAR_TO 94}20BP");
const u8 gText_Leftovers48BP[] = _("LEFTOVERS{CLEAR_TO 94}25BP");
const u8 gText_ChoiceBand64BP[] = _("CHOICE BAND{CLEAR_TO 94}25BP");
const u8 gText_ScopeLens64BP[] = _("SCOPE LENS{CLEAR_TO 94}25BP");
const u8 gText_SootheBell25BP[] = _("SOOTHE BELL{CLEAR_TO 94}25BP");
const u8 gText_Softboiled16BP[] = _("SOFTBOILED{CLEAR_TO 84}5BP");
const u8 gText_SeismicToss24BP[] = _("SEISMIC TOSS{CLEAR_TO 84}5BP");
const u8 gText_DreamEater24BP[] = _("DREAM EATER{CLEAR_TO 84}5BP");
const u8 gText_MegaPunch24BP[] = _("MEGA PUNCH{CLEAR_TO 84}5BP");
const u8 gText_MegaKick48BP[] = _("MEGA KICK{CLEAR_TO 84}7BP");
const u8 gText_BodySlam48BP[] = _("BODY SLAM{CLEAR_TO 84}7BP");
const u8 gText_RockSlide48BP[] = _("ROCK SLIDE{CLEAR_TO 84}5BP");
const u8 gText_Counter48BP[] = _("COUNTER{CLEAR_TO 78}10BP");
const u8 gText_ThunderWave48BP[] = _("THUNDER WAVE{CLEAR_TO 84}5BP");
const u8 gText_SwordsDance48BP[] = _("SWORDS DANCE{CLEAR_TO 84}5BP");
const u8 gText_DefenseCurl16BP[] = _("DEFENSE CURL{CLEAR_TO 84}2BP");
const u8 gText_Snore24BP[] = _("SNORE{CLEAR_TO 84}2BP");
const u8 gText_Nightmare5BP[] = _("NIGHTMARE{CLEAR_TO 84}5BP");
const u8 gText_MudSlap24BP[] = _("MUD-SLAP{CLEAR_TO 84}5BP");
const u8 gText_Swift24BP[] = _("SWIFT{CLEAR_TO 84}2BP");
const u8 gText_IcyWind24BP[] = _("ICY WIND{CLEAR_TO 84}7BP");
const u8 gText_SelfDestruct10BP[] = _("SELFDESTRUCT{CLEAR_TO 78}10BP");
const u8 gText_Endure48BP[] = _("ENDURE{CLEAR_TO 84}5BP");
const u8 gText_PsychUp48BP[] = _("PSYCH UP{CLEAR_TO 84}5BP");
const u8 gText_IcePunch48BP[] = _("ICE PUNCH{CLEAR_TO 84}5BP");
const u8 gText_ThunderPunch48BP[] = _("THUNDERPUNCH{CLEAR_TO 84}5BP");
const u8 gText_FirePunch48BP[] = _("FIRE PUNCH{CLEAR_TO 84}5BP");
const u8 gText_SkyAttack10BP[] = _("SKY ATTACK{CLEAR_TO 78}10BP");
...
const u8 gText_ApprenticeGive[] = _("Give");
...
const u8 gText_BattleScene[] = _("BATTLE EFFECTS");
...
const u8 gText_MessageBox[] = _("MESSAGE BOX");
...
const u8 gText_BattleStyleShift[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}SWITCH");
...
const u8 gText_AttackStyleType[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}TYPE");
const u8 gText_AttackStyleCategory[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}CATEGORY");
...
const u8 gText_MessageBoxGreen[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}GREEN");
const u8 gText_MessageBoxBlue[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}BLUE");
const u8 gText_FrameType[] = _("{COLOR RED}{SHADOW LIGHT_RED}TYPE");
const u8 gText_FrameTypeNumber[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}");
const u8 gText_ButtonTypeDefault[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}DEFAULT");
