...
static void CB2_CreateTradeMenu(void)
{
    ...
    case 12:
        ...
        xPos = GetStringCenterAlignXOffset(gSaveBlock2Ptr->optionsCurrentFont, gSaveBlock2Ptr->playerName, 120);
        ...
        xPos = GetStringCenterAlignXOffset(gSaveBlock2Ptr->optionsCurrentFont, gLinkPlayers[GetMultiplayerId() ^ 1].name, 120);
...
static void DrawSelectedMonScreen(u8 whichParty)
{
    ...
    case 3:
        ...
        AddTextPrinterParameterized4((whichParty * 2) + 15, gSaveBlock2Ptr->optionsCurrentFont, 0, 0, 0, 0, sTradeTextColors, 0, movesString);
...
static void PrintTradeMessage(u8 messageId)
{
    ...
    AddTextPrinterParameterized(0, gSaveBlock2Ptr->optionsCurrentFont, sMessages[messageId], 0, 0, TEXT_SKIP_DRAW, NULL);
...
void DrawTextOnTradeWindow(u8 windowId, const u8 *str, u8 speed)
{
    ...
    AddTextPrinterParameterized4(windowId, gSaveBlock2Ptr->optionsCurrentFont, 0, 2, 0, 0, sTradeAnim->textColors, speed, str);
    CopyWindowToVram(windowId, COPYWIN_FULL);
}
