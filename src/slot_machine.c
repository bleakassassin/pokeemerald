...
static bool8 SlotTask_PrintMsg_Need3Coins(struct Task *task)
{
    ...
    AddTextPrinterParameterized(0, gSaveBlock2Ptr->optionsCurrentFont, gText_YouDontHaveThreeCoins, 0, 1, 0, 0);
...
{
    DrawDialogueFrame(0, 0);
    AddTextPrinterParameterized(0, gSaveBlock2Ptr->optionsCurrentFont, gText_QuitTheGame, 0, 1, 0, 0);
    CopyWindowToVram(0, COPYWIN_FULL);
...
{
    DrawDialogueFrame(0, 0);
    AddTextPrinterParameterized(0, gSaveBlock2Ptr->optionsCurrentFont, gText_YouveGot9999Coins, 0, 1, 0, 0);
    CopyWindowToVram(0, COPYWIN_FULL);
...
{
    DrawDialogueFrame(0, 0);
    AddTextPrinterParameterized(0, gSaveBlock2Ptr->optionsCurrentFont, gText_YouveRunOutOfCoins, 0, 1, 0, 0);
    CopyWindowToVram(0, COPYWIN_FULL);
...
{
    AddTextPrinterParameterized3(1, gSaveBlock2Ptr->optionsCurrentFont, 2, 5, sColors_ReeltimeHelp, 0, gText_ReelTimeHelp);
