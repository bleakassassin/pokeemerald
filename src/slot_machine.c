...
static bool8 SlotTask_PrintMsg_Need3Coins(struct Task *task)
{
    ...
    AddTextPrinterParameterized(0, gSaveBlock2Ptr->optionsCurrentFont, gText_YouDontHaveThreeCoins, 0, 0, 0, 0);
...
{
    DrawDialogueFrame(0, FALSE);
    AddTextPrinterParameterized(0, gSaveBlock2Ptr->optionsCurrentFont, gText_QuitTheGame, 0, 0, 0, 0);
    CopyWindowToVram(0, COPYWIN_FULL);
...
{
    DrawDialogueFrame(0, FALSE);
    AddTextPrinterParameterized(0, gSaveBlock2Ptr->optionsCurrentFont, gText_YouveGot9999Coins, 0, 0, 0, 0);
    CopyWindowToVram(0, COPYWIN_FULL);
...
{
    DrawDialogueFrame(0, FALSE);
    AddTextPrinterParameterized(0, gSaveBlock2Ptr->optionsCurrentFont, gText_YouveRunOutOfCoins, 0, 0, 0, 0);
    CopyWindowToVram(0, COPYWIN_FULL);
...
{
    AddTextPrinterParameterized3(1, gSaveBlock2Ptr->optionsCurrentFont, 2, 4, sColors_ReeltimeHelp, 0, gText_ReelTimeHelp);
