...
static bool8 SlotTask_PrintMsg_Need3Coins(struct Task *task)
{
    ...
    AddTextPrinterParameterized(WIN_MSG, gSaveBlock2Ptr->optionsCurrentFont, gText_YouDontHaveThreeCoins, 0, 0, 0, 0);
...
{
    DrawDialogueFrame(WIN_MSG, FALSE);
    AddTextPrinterParameterized(WIN_MSG, gSaveBlock2Ptr->optionsCurrentFont, gText_QuitTheGame, 0, 0, 0, 0);
    CopyWindowToVram(WIN_MSG, COPYWIN_FULL);
...
{
    DrawDialogueFrame(WIN_MSG, FALSE);
    AddTextPrinterParameterized(WIN_MSG, gSaveBlock2Ptr->optionsCurrentFont, gText_YouveGot9999Coins, 0, 0, 0, 0);
    CopyWindowToVram(WIN_MSG, COPYWIN_FULL);
...
{
    DrawDialogueFrame(WIN_MSG, FALSE);
    AddTextPrinterParameterized(WIN_MSG, gSaveBlock2Ptr->optionsCurrentFont, gText_YouveRunOutOfCoins, 0, 0, 0, 0);
    CopyWindowToVram(WIN_MSG, COPYWIN_FULL);
...
{
    AddTextPrinterParameterized3(WIN_INFO, gSaveBlock2Ptr->optionsCurrentFont, 2, 4, sColors_ReeltimeHelp, 0, gText_ReelTimeHelp);
