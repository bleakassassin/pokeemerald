...
const u32 gMonFrontPic_CircledQuestionMark[] = INCGFX_U32("graphics/pokemon/question_mark/circled/front.png", ".4bpp.lz");
...
const u32 gBagRSPalette[] = INCGFX_U32("graphics/bag/bag_rs.pal", ".gbapal.lz");
...
const u16 gMessageBoxRS_Pal[] = INCGFX_U16("graphics/text_window/message_box_rs.png", ".gbapal");
