...
static bool32 UpdateConditionGraphMenuWindows(u8 mode, u16 bufferIndex, bool8 winMode)
{
    ...
    case 1:
        if (GetConditionGraphCurrentListIndex() != GetMonListCount() - 1 || IsConditionMenuSearchMode() == TRUE)
        {
            ...
            AddTextPrinterParameterized(menu->nameGenderWindowId, gSaveBlock2Ptr->optionsCurrentFont, str, 0, 1, 0, NULL);
        }
        break;
    case 2:
        if (IsConditionMenuSearchMode() == TRUE)
        {
            ...
            AddTextPrinterParameterized(menu->nameGenderWindowId, gSaveBlock2Ptr->optionsCurrentFont, str, 0, 17, 0, NULL);
