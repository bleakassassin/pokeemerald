...
const struct MonCoords gMonBackPicCoords[] =
{
    ...
    [SPECIES_CHARMANDER]  = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 10 },
    [SPECIES_CHARMELEON]  = { .size = MON_COORDS_SIZE(48, 56), .y_offset =  7 },
    [SPECIES_CHARIZARD]   = { .size = MON_COORDS_SIZE(64, 56), .y_offset =  4 },
    [SPECIES_SQUIRTLE]    = { .size = MON_COORDS_SIZE(48, 40), .y_offset = 15 },
    ...
    [SPECIES_METAPOD]     = { .size = MON_COORDS_SIZE(40, 40), .y_offset = 12 },
    ...
    [SPECIES_HAUNTER]     = { .size = MON_COORDS_SIZE(48, 48), .y_offset =  9 },
    ...
    [SPECIES_MAROWAK]     = { .size = MON_COORDS_SIZE(40, 48), .y_offset =  8 },
    ...
    [SPECIES_CHANSEY]     = { .size = MON_COORDS_SIZE(64, 48), .y_offset = 14 },
