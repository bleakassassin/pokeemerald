static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_ROUTE111_TRAINER_HILL - 1] = {MAP_GROUP(ROUTE111), MAP_NUM(ROUTE111), 31, 114},
    [HEAL_LOCATION_ROUTE111_REST_STOP - 1] = {MAP_GROUP(ROUTE111), MAP_NUM(ROUTE111), 26, 19},
    [HEAL_LOCATION_ROUTE119_WEATHER_INSTITUTE - 1] = {MAP_GROUP(ROUTE119), MAP_NUM(ROUTE119), 6, 33},
};
