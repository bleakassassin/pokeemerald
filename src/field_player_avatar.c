...
static const u16 sPlayerAvatarGfxIds[OUTFIT_TOTAL][PLAYER_AVATAR_STATE_COUNT][GENDER_COUNT] =
{
    [OUTFIT_EMERALD] =
    {
    ...
    [OUTFIT_RS] =
    {
        ...
        [PLAYER_AVATAR_STATE_BIKE]       = {OBJ_EVENT_GFX_RS_BRENDAN_BIKE,       OBJ_EVENT_GFX_RS_MAY_BIKE},
...
static const u16 sPlayerAvatarGfxToStateFlag[OUTFIT_TOTAL][GENDER_COUNT][4][2] =
{
    [OUTFIT_EMERALD] =
    {
        [MALE] =
        {
            ...
            {OBJ_EVENT_GFX_BRENDAN_BIKE,       PLAYER_AVATAR_FLAG_BIKE},
        ...
        [FEMALE] =
        {
            ...
            {OBJ_EVENT_GFX_MAY_BIKE,           PLAYER_AVATAR_FLAG_BIKE},
    ...
    [OUTFIT_RS] =
    {
        [MALE] =
        {
            ...
            {OBJ_EVENT_GFX_RS_BRENDAN_BIKE,       PLAYER_AVATAR_FLAG_BIKE},
        ...
        [FEMALE] =
        {
            ...
            {OBJ_EVENT_GFX_RS_MAY_BIKE,           PLAYER_AVATAR_FLAG_BIKE},
...
{
    return sPlayerAvatarGfxIds[gSaveBlock2Ptr->outfitId][state][gSaveBlock2Ptr->playerGender];
}
...
u8 unref_GetRivalAvatarGenderByGraphicsId(u16 gfxId)
{
    ...
    case OBJ_EVENT_GFX_RIVAL_MAY_BIKE:
...
//                task->tRoundsPlayed++;
            ...
            {
                AddTextPrinterParameterized(0, gSaveBlock2Ptr->optionsCurrentFont, dot, task->tNumDots * 8, 1, 0, NULL);
                task->tNumDots++;
            }
        }
        return FALSE;
...
{
    AlignFishingAnimationFrames();
    AddTextPrinterParameterized(0, gSaveBlock2Ptr->optionsCurrentFont, gText_OhABite, 0, 17, 0, NULL);
    task->tStep++;
    task->tFrameCounter = 0;
    return FALSE;
}
...
static bool8 Fishing_MonOnHook(struct Task *task)
{
    ...
    AddTextPrinterParameterized2(0, gSaveBlock2Ptr->optionsCurrentFont, gText_PokemonOnHook, 1, 0, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_WHITE, TEXT_COLOR_LIGHT_GRAY);
    task->tStep++;
    task->tFrameCounter = 0;
    return FALSE;
}
...
static bool8 Fishing_NotEvenNibble(struct Task *task)
{
    ...
    FillWindowPixelBuffer(0, PIXEL_FILL(1));
    AddTextPrinterParameterized2(0, gSaveBlock2Ptr->optionsCurrentFont, gText_NotEvenANibble, 1, 0, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_WHITE, TEXT_COLOR_LIGHT_GRAY);
...
static bool8 Fishing_GotAway(struct Task *task)
{
    ...
    StartSpriteAnim(&gSprites[gPlayerAvatar.spriteId], GetFishingNoCatchDirectionAnimNum(GetPlayerFacingDirection()));
    FillWindowPixelBuffer(0, PIXEL_FILL(1));
    AddTextPrinterParameterized2(0, gSaveBlock2Ptr->optionsCurrentFont, gText_ItGotAway, 1, 0, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_WHITE, TEXT_COLOR_LIGHT_GRAY);
    gChainEncounterStreak = 0;
    gLastWildSpecies = SPECIES_NONE;
    task->tStep++;
    return TRUE;
