...
static const u8 sPlayerAvatarGfxToStateFlag[COSTUME_COUNT][2][5][2] =
{
    ...
    [COSTUME_1] =
    {
        [MALE] =
        {
            ...
            {OBJ_EVENT_GFX_LINK_RS_BRENDAN,    PLAYER_AVATAR_FLAG_MACH_BIKE},
            {OBJ_EVENT_GFX_LINK_RS_BRENDAN,    PLAYER_AVATAR_FLAG_ACRO_BIKE},
            {OBJ_EVENT_GFX_LINK_RS_BRENDAN,    PLAYER_AVATAR_FLAG_SURFING},
            {OBJ_EVENT_GFX_LINK_RS_BRENDAN,    PLAYER_AVATAR_FLAG_UNDERWATER},
        },
        [FEMALE] =
        {
            {OBJ_EVENT_GFX_LINK_RS_MAY,        PLAYER_AVATAR_FLAG_ON_FOOT},
            {OBJ_EVENT_GFX_LINK_RS_MAY,        PLAYER_AVATAR_FLAG_MACH_BIKE},
            {OBJ_EVENT_GFX_LINK_RS_MAY,        PLAYER_AVATAR_FLAG_ACRO_BIKE},
            {OBJ_EVENT_GFX_LINK_RS_MAY,        PLAYER_AVATAR_FLAG_SURFING},
            {OBJ_EVENT_GFX_LINK_RS_MAY,        PLAYER_AVATAR_FLAG_UNDERWATER},
        },
    },
};
