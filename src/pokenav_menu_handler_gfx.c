...
static void PrintCurrentOptionDescription(void)
{
    ...
    u32 width = GetStringWidth(gSaveBlock2Ptr->optionsCurrentFont, desc, -1);
    FillWindowPixelBuffer(gfx->optionDescWindowId, PIXEL_FILL(6));
    AddTextPrinterParameterized3(gfx->optionDescWindowId, gSaveBlock2Ptr->optionsCurrentFont, (192 - width) / 2, 0, sOptionDescTextColors, 0, desc);
}
...
static void PrintNoRibbonWinners(void)
{
    ...
    u32 width = GetStringWidth(gSaveBlock2Ptr->optionsCurrentFont, s, -1);
    FillWindowPixelBuffer(gfx->optionDescWindowId, PIXEL_FILL(6));
    AddTextPrinterParameterized3(gfx->optionDescWindowId, gSaveBlock2Ptr->optionsCurrentFont, (192 - width) / 2, 1, sOptionDescTextColors2, 0, s);
}
