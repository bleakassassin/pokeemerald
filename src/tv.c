...
static const struct {
    ...
    },
    {
        ...
        .moves = {MOVE_ABSORB, MOVE_GROWTH, MOVE_POISON_POWDER, MOVE_VINE_WHIP},
        .level = 25,
        .location = MAP_NUM(MAP_ROUTE119),
    },
    {
        .species = SPECIES_YANMA,
        .moves = {MOVE_FORESIGHT, MOVE_QUICK_ATTACK, MOVE_DOUBLE_TEAM, MOVE_SONIC_BOOM},
        .level = 18,
        .location = MAP_NUM(MAP_ROUTE120),
    },
    {
        .species = SPECIES_WEEPINBELL,
        .moves = {MOVE_SLEEP_POWDER, MOVE_POISON_POWDER, MOVE_STUN_SPORE, MOVE_ACID},
        .level = 28,
