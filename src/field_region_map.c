...
static void FieldUpdateRegionMap(void)
{
    ...
    switch (sFieldRegionMapHandler->state)
    {
        ...
        case 1:
            ...
            AddTextPrinterParameterized(1, gSaveBlock2Ptr->optionsCurrentFont, gText_Hoenn, offset, 1, 0, NULL);
...
static void PrintRegionMapSecName(void)
{
    if (sFieldRegionMapHandler->regionMap.mapSecType != MAPSECTYPE_NONE)
    {
        ...
        AddTextPrinterParameterized(0, gSaveBlock2Ptr->optionsCurrentFont, sFieldRegionMapHandler->regionMap.mapSecName, 0, 1, 0, NULL);
        ScheduleBgCopyTilemapToVram(0);
    }
    else
    {
