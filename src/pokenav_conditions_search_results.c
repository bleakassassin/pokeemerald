...
static void PrintSearchResultListMenuItems(struct Pokenav_SearchResultsGfx *gfx)
{
    ...
    *gStringVar1 = EOS;
    ...
    AddTextPrinterParameterized(gfx->winid, gSaveBlock2Ptr->optionsCurrentFont, gStringVar2, 4, 1, TEXT_SKIP_DRAW, NULL);
    ConvertIntToDecimalStringN(gStringVar1, rank, STR_CONV_MODE_RIGHT_ALIGN, 3);
    AddTextPrinterParameterized(gfx->winid, gSaveBlock2Ptr->optionsCurrentFont, gStringVar1, 34, 1, TEXT_SKIP_DRAW, NULL);
...
static void CreateSearchResultsList(void)
{
    ...
    template.fontId = gSaveBlock2Ptr->optionsCurrentFont;
...
static void BufferSearchMonListItem(struct PokenavMonListItem * item, u8 * dest)
{
    ...
    dest = GetStringClearToWidth(dest, gSaveBlock2Ptr->optionsCurrentFont, gStringVar3, 60);
    switch (gender)
    {
    default:
    ...
    *s++ = CHAR_LV_2;
    ...
    GetStringClearToWidth(dest, gSaveBlock2Ptr->optionsCurrentFont, gStringVar1, 40);
}
