...
{
    {gText_EmptyString, gText_DexSearchTypeNone},
    {gText_EmptyString, gTypeNames[TYPE_NORMAL]},
    {gText_EmptyString, gTypeNames[TYPE_FIGHTING]},
    {gText_EmptyString, gTypeNames[TYPE_FLYING]},
    {gText_EmptyString, gTypeNames[TYPE_POISON]},
    {gText_EmptyString, gTypeNames[TYPE_GROUND]},
    {gText_EmptyString, gTypeNames[TYPE_ROCK]},
    {gText_EmptyString, gTypeNames[TYPE_BUG]},
    {gText_EmptyString, gTypeNames[TYPE_GHOST]},
    {gText_EmptyString, gTypeNames[TYPE_STEEL]},
    {gText_EmptyString, gTypeNames[TYPE_FIRE]},
    {gText_EmptyString, gTypeNames[TYPE_WATER]},
    {gText_EmptyString, gTypeNames[TYPE_GRASS]},
    {gText_EmptyString, gTypeNames[TYPE_ELECTRIC]},
    {gText_EmptyString, gTypeNames[TYPE_PSYCHIC]},
    {gText_EmptyString, gTypeNames[TYPE_ICE]},
    {gText_EmptyString, gTypeNames[TYPE_DRAGON]},
    {gText_EmptyString, gTypeNames[TYPE_DARK]},
    {},
};
    ...
    case 3:
        {
            ...
            PrintInfoScreenText(string, GetStringCenterAlignXOffset(gSaveBlock2Ptr->optionsCurrentFont, string, DISPLAY_WIDTH), 121);
            gMain.state++;
        }
        break;
    case 4:
...
static void PrintMonInfo(u32 num, u32 value, u32 owned, u32 newEntry)
{
    ...
    if (newEntry)
        PrintInfoScreenText(gText_PokedexRegistration, GetStringCenterAlignXOffset(gSaveBlock2Ptr->optionsCurrentFont, gText_PokedexRegistration, DISPLAY_WIDTH), 0);
    if (value == 0)
    ...
    PrintInfoScreenText(description, GetStringCenterAlignXOffset(gSaveBlock2Ptr->optionsCurrentFont, description, DISPLAY_WIDTH), 95);
}
