...
static const struct MenuAction sPokeblockMenuActions[] =
{
    ...
    [PKBL_TOSS]          = {gText_Toss,    {PokeblockAction_Toss}},
    ...
    [PKBL_GIVE_TO_LADY]  = {gText_Give,    {PokeblockAction_GiveToContestLady}},
};
...
static void PokeblockAction_Toss(u8 taskId)
{
    ...
    DisplayMessageAndContinueTask(taskId, WIN_TOSS_MSG, 10, 13, gSaveBlock2Ptr->optionsCurrentFont, GetPlayerTextSpeedDelay(), gStringVar4, CreateTossPokeblockYesNoMenu);
}
...
static void TossedPokeblockMessage(u8 taskId)
{
    ...
    DisplayMessageAndContinueTask(taskId, WIN_TOSS_MSG, 10, 13, gSaveBlock2Ptr->optionsCurrentFont, GetPlayerTextSpeedDelay(), gStringVar4, TossPokeblock);
}
