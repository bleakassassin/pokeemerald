...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_SIDNEY] = REMATCH(TRAINER_SIDNEY_2, TRAINER_SIDNEY_2, TRAINER_SIDNEY_2, TRAINER_SIDNEY_2, TRAINER_SIDNEY_2, MAP_EVER_GRANDE_CITY),
    [REMATCH_PHOEBE] = REMATCH(TRAINER_PHOEBE_2, TRAINER_PHOEBE_2, TRAINER_PHOEBE_2, TRAINER_PHOEBE_2, TRAINER_PHOEBE_2, MAP_EVER_GRANDE_CITY),
    [REMATCH_GLACIA] = REMATCH(TRAINER_GLACIA_2, TRAINER_GLACIA_2, TRAINER_GLACIA_2, TRAINER_GLACIA_2, TRAINER_GLACIA_2, MAP_EVER_GRANDE_CITY),
    [REMATCH_DRAKE] = REMATCH(TRAINER_DRAKE_2, TRAINER_DRAKE_2, TRAINER_DRAKE_2, TRAINER_DRAKE_2, TRAINER_DRAKE_2, MAP_EVER_GRANDE_CITY),
    ...
    [REMATCH_GL_WALLACE] = REMATCH(TRAINER_WALLACE_LEADER, TRAINER_WALLACE_LEADER, TRAINER_WALLACE_LEADER, TRAINER_WALLACE_LEADER, TRAINER_WALLACE_LEADER, MAP_SOOTOPOLIS_CITY),
};
...
static u8 GetTrainerBattleTransition(void)
{
    ...
    {
        if (gTrainerBattleOpponent_A == TRAINER_STEVEN_CHAMPION)
    ...
    for (i = 0; i <= REMATCH_SPECIAL_TRAINER_START; i++)
    {
        if (table[i].mapGroup == mapGroup && table[i].mapNum == mapNum && !IsRematchForbidden(i))
        {
            if (gSaveBlock1Ptr->trainerRematches[i] != 0)
            {
             ...
             && (Random() % 100) < 70)  // 70% chance of getting a rematch.
            {
