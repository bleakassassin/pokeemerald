...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_SIDNEY] = REMATCH(TRAINER_SIDNEY_2, TRAINER_SIDNEY_2, TRAINER_SIDNEY_2, TRAINER_SIDNEY_2, TRAINER_SIDNEY_2, EVER_GRANDE_CITY),
    [REMATCH_PHOEBE] = REMATCH(TRAINER_PHOEBE_2, TRAINER_PHOEBE_2, TRAINER_PHOEBE_2, TRAINER_PHOEBE_2, TRAINER_PHOEBE_2, EVER_GRANDE_CITY),
    [REMATCH_GLACIA] = REMATCH(TRAINER_GLACIA_2, TRAINER_GLACIA_2, TRAINER_GLACIA_2, TRAINER_GLACIA_2, TRAINER_GLACIA_2, EVER_GRANDE_CITY),
    [REMATCH_DRAKE] = REMATCH(TRAINER_DRAKE_2, TRAINER_DRAKE_2, TRAINER_DRAKE_2, TRAINER_DRAKE_2, TRAINER_DRAKE_2, EVER_GRANDE_CITY),
    [REMATCH_WALLACE] = REMATCH(TRAINER_WALLACE, TRAINER_WALLACE, TRAINER_WALLACE, TRAINER_WALLACE, TRAINER_WALLACE, EVER_GRANDE_CITY),
    [REMATCH_GL_WALLACE] = REMATCH(TRAINER_WALLACE_LEADER, TRAINER_WALLACE_LEADER, TRAINER_WALLACE_LEADER, TRAINER_WALLACE_LEADER, TRAINER_WALLACE_LEADER, SOOTOPOLIS_CITY),
};
